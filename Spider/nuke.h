 ...
 */
#define X_COXA      55  // MM between front and back legs /2 //47
#define Y_COXA      55  // MM between front/back legs /2  //47

/* Legs */
#define L_COXA      35  // MM distance from coxa servo to femur servo //34
#define L_FEMUR     82  // MM distance from femur servo to tibia servo //45
#define L_TIBIA     80  // MM distance from tibia servo to foot 70
